...
import { useGetAllCommentsQuery, useGetCommentQuery, useGetAllCommentRepliesQuery } from '../../../../api/services/comments.ts'
...
export default (topicId, discussionId, commentId, modalProps) => {
  ...
  ) || {data: commentData?.comment, children: commentData?.replies ? [...commentData?.replies] : []}
  ...
  }, [topic, currentUser, comment, discussionId, modalProps, commentId])
}
